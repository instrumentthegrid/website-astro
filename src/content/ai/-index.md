---
banner:
  title: Harmonizing AI Infrastructure at the the Nexus of Power, Communications and Applied AI
...
feature:
  ...
  button:
    ...
    enable: true
  features:
    - name: "Reliability Oversight"
      icon: "FaLock"
      content: ISO/RTO/RC/TOs oversee reliability for bulk power system, but only “see” bulk power and transmission systems (>100kV); Except the grid doesn’t stop at 100kV.
    - name: "NERC/FERC Compliance"
      icon: "FaCheck"
      content: NERC/FERC now aggressively responding to data center impact on grid reliability through IBR-related interconnect, compliance & reporting requirements.
    - name: "Bulk Power Impact"
      icon: "FaChartLine"
      content: General AI & LLM Training Data Centers cause large power fluctuations on bulk power system, representing reliability and cascading outage risk. 
...
services:
  ...
  - title: About GridVisibility
    description: GridVisibility harnesses the existing broadband infrastructure to rapidly deliver real-time, all-the-time, electrical data; enabling unprecedented visibility and situational awareness of distribution grid behaviors. Deployment of GVP sensors in regions with high data center concentrations will provide essential visibility and grid reliability insights, including incipient events leading to distribution grid outages, allowing proactive remediation before localized or cascading outages occur.
    slider_images:
